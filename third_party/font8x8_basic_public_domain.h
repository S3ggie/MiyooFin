#ifndef MIYOOFIN_FONT8X8_BASIC_PUBLIC_DOMAIN_H
#define MIYOOFIN_FONT8X8_BASIC_PUBLIC_DOMAIN_H

#include <cstdint>

/*
 * Printable-ASCII subset of Daniel Hepper's font8x8_basic.h.
 * Upstream author: Daniel Hepper <daniel@hepper.net>
 ...
 *
 * Only U+0020 through U+007E are retained here. Upstream rows are encoded
 * least-significant-bit first; BitmapFont.cpp converts them to MiyooFin's
 * MSB-first 8x16 representation by reversing each row and doubling it.
 */
static const uint8_t kMiyooFinFont8x8Basic[95][8] = {
...
#endif // MIYOOFIN_FONT8X8_BASIC_PUBLIC_DOMAIN_H
