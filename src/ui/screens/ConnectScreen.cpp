...
void ConnectScreen::render(SDL_Surface* fb)
{
    ...
    if (m_connected) {
        ...
        int l1y = fb->h / 3;
        BitmapFont::drawString(fb, l1x, l1y, line1, Theme::ACCENT_R, Theme::ACCENT_G,
        ...
        BitmapFont::drawString(fb, l2x, l2y, line2, Theme::TEXT_R, Theme::TEXT_G, Theme::TEXT_B,
                               Theme::BG_R, Theme::BG_G, Theme::BG_B);
        ...
        BitmapFont::drawString(fb, l3x, l3y, line3, Theme::TEXT_R, Theme::TEXT_G, Theme::TEXT_B,
                               Theme::BG_R, Theme::BG_G, Theme::BG_B);
