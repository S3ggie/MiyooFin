...
inline constexpr int FB_W=640, HEAD_X=22, HEAD_Y=16, GRID_TOP_Y=51, GRID_ROW_H=135, GRID_ROWS=3;
inline constexpr int POSTER_W=74, POSTER_H=111, OVERLAY_H=18, SHOW_X=360, SHOW_Y=51, SHOW_W=160, SHOW_H=240, META_X=363;
inline constexpr int COL_X[2]={48,154};
inline constexpr int GRID_VISIBLE=6;
inline int gridRowCount(int totalSeasons) { return (totalSeasons + GRID_COLS - 1) / GRID_COLS; }
