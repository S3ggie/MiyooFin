...
int main()
{
    ...
    testCoordinatorCommittedGenerationStatus();
    ...
    testCardSurfaceCacheEviction();
    testNonBlockingFinishPolicy();
    testRefreshMovieFilterHomeNavPreserved();
