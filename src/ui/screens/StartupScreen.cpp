...
void StartupScreen::render(SDL_Surface* fb)
{
    ...
    BitmapFont::drawString(fb, titleX, titleY, title, Theme::ACCENT_R, Theme::ACCENT_G,
    ...
    BitmapFont::drawString(fb, verX, verY, ver, Theme::TEXT_R, Theme::TEXT_G, Theme::TEXT_B,
    ...
    if (m_age > 500) {
        ...
        BitmapFont::drawString(fb, hintX, hintY, hint, Theme::TEXT_R, Theme::TEXT_G, Theme::TEXT_B,
                               Theme::BG_R, Theme::BG_G, Theme::BG_B);
    }
}
