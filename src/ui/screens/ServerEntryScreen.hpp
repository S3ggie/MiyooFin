...
class ServerEntryScreen : public Screen
{
  public:
    ...
    bool localAddressEntry() const
    {
        return m_localAddressEntry;
    }
    bool publicAddressEntry() const
    {
        return m_publicAddressEntry;
    }
    bool addressEntryCancelled() const
    {
        return m_addressEntryCancelled;
    }
