...
class JellyfinApi
{
  public:
    ...
    static bool authenticateByName(const std::string& baseUrl, const std::string& username,
    ...
    getPlaybackPositionTicks(const std::string& baseUrl, const std::string& accessToken,
                             const std::string& userId, const std::string& deviceId,
                             const std::string& itemId, std::int64_t& ticks, std::string& error);
    ...
    static bool getViews(const std::string& baseUrl, const std::string& accessToken,
                         const std::string& userId, const std::string& deviceId,
    ...
    static bool getLibraryItemsPage(const std::string& baseUrl, const std::string& accessToken,
                                    const std::string& userId, const std::string& deviceId,
                                    const std::string& parentId,
                                    const std::string& includeItemTypes, int startIndex, int limit,
    ...
    static bool getLibraryItemsPage(const std::string& baseUrl, const std::string& accessToken,
                                    ...
                                    const std::string& parentId,
                                    const std::string& includeItemTypes, int startIndex, int limit,
                                    LibraryItemsPage& page, std::string& error, HttpClient& client,
                                    const std::atomic<bool>* cancelled = nullptr);
    ...
    static bool getChangedCatalogItems(const std::string& baseUrl, const std::string& accessToken,
                                       const std::string& userId, const std::string& deviceId,
    ...
    static bool getItemsByIds(const std::string& baseUrl, const std::string& accessToken,
                              const std::string& userId, const std::string& deviceId,
    ...
    static bool getResumeItems(const std::string& baseUrl, const std::string& accessToken,
    ...
    static bool getResumeItems(const std::string& baseUrl, const std::string& accessToken,
                               const std::string& userId, const std::string& deviceId, int limit,
                               std::vector<MediaItem>& items, std::string& error,
                               HttpClient& client, const std::atomic<bool>* cancelled = nullptr);

    /// Fetch "recently added" items across all libraries.
    static bool getLatestItems(const std::string& baseUrl, const std::string& accessToken,
                               const std::string& userId, const std::string& deviceId, int limit,
                               std::vector<MediaItem>& items, std::string& error,
                               const std::atomic<bool>* cancelled = nullptr);
    ...
    static bool getSeasons(const std::string& baseUrl, const std::string& accessToken,
                           const std::string& userId, const std::string& deviceId,
                           const std::string& seriesId, std::vector<MediaItem>& seasons,
                           std::string& error, const std::atomic<bool>* cancelled = nullptr);

    /// Fetch episodes for a given season of a series.
    static bool getEpisodes(const std::string& baseUrl, const std::string& accessToken,
                            const std::string& userId, const std::string& deviceId,
                            const std::string& seriesId, const std::string& seasonId,
                            std::vector<MediaItem>& episodes, std::string& error,
                            const std::atomic<bool>* cancelled = nullptr);
    ...
    static bool getDownloadMediaSources(const std::string& baseUrl, const std::string& accessToken,
                                        const std::string& userId, const std::string& deviceId,
    ...
    static std::string buildLatestUrl(const std::string& baseUrl, const std::string& userId,
                                      int limit);

    /// Build a paginated library-items URL.
    static std::string buildLibraryItemsUrl(const std::string& baseUrl, const std::string& userId,
                                            const std::string& parentId,
    ...
    static std::vector<std::string> buildAuthHeaders(const std::string& accessToken,
                                                     const std::string& deviceId);

  private:
    static std::string extractString(const std::string& json, const std::string& key);
    static std::string extractNestedString(const std::string& json, const std::string& parent,
