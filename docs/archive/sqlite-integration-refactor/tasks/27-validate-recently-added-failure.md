# Task 27 — Validate Recently Added failure

**Phase:** C — validation

## Objective

Prove Recently Added failure still permits a complete supported library generation.

## Why

This is the second exact optional-rail regression fixed by Task 01.
...
1. Force Recently Added seam to fail while Continue Watching and all supported view/page responses succeed.
...
- Rail status unavailable without truncation.
...
```text
test(home): cover recently added failure
```

Do not include any part of Task 28 in this commit.
